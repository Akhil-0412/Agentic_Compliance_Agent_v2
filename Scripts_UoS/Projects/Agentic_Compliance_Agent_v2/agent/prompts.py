...
User: "We lost 5000 records of patient data. What specifically do we do under GDPR?"
Response:
{
  "summary": "The user is asking about a data breach involving 5000 records. Under GDPR, this requires notification to the supervisory authority (Art. 33) and potentially the data subjects (Art. 34) due to high risk.",
  "reasoning_map": [
    {
    ...
    },
    {
      ...
      "regulation": "GDPR",
      "article": "34",
      "justification": "Article 34 requires communication of the breach to the data subject when there is a high risk."
    }
  ],
  "confidence": 1.0,
  "risk_level": "High"
